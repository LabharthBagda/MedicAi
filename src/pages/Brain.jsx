    ...
    <div className="analysis-layout">
      <div className="scan-viewer">
        <div className="viewer-header">
          <h2 className="viewer-title">Brain MRI Analysis</h2>
        ...
        <div className="viewer-content">
          {loading ? (
            ...
            <img src={URL.createObjectURL(file)} alt="Brain MRI" className="uploaded-image" />
          ) : (
        ...
        {result ? (
          ...
          <div className="confidence-section">
            ...
            <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", marginBottom: "1rem" }}>
              {file ? "Click analyze to process the scan" : "Upload a brain MRI to begin analysis"}
            </p>
            <button 
